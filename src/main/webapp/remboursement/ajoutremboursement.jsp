    ...
    <form action="<%=request.getContextPath()%>/remboursement" method="post">
        ...
        <div class="form-group">
            <select name="beneficiaireId" required>
                ...
                <%
                    // Récupération de la liste des bénéficiaires depuis l'attribut de requête
        ...
        <div class="form-group">
            <input type="number" step="0.01" name="montant" placeholder="Montant du remboursement (MAD)" required/>
        ...
        <input type="submit" value="Ajouter le remboursement"/>
    </form>
